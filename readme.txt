...
INFO: xwolf hat einiges im Orginal-Theme geändert, die Zusatzfunktionen von Piratenkleider-GP ist jetzt nahezu vollständig auch mit Piratenkleider durchführbar. Aus Zeitgründen kann ich diesen Fork aktuell nicht mehr mit den Änderungen von xwolf up-to-date halten.
...
= 11.02.2014 - v1.7.8 =
-- Politics Head für die Navigation
= 11.02.2014 - v1.7.7 =
-- CSS Bugifx
= 11.02.2014 - v1.7.6 =
...
-- meta-viewport Anpassungen (user-scalable: no)
= 30.04.2013 - v1.6.5 =
-- Bugfix Politics Head
= 30.04.2013 - v1.6.4 =
-- Politics Head woff
= 30.04.2013 - v1.6.3 =
...
-- Bugfix #searchform
= 17.03.2013 - v1.4.2 =
-- Einige Anzeigefehler korrigiert
= 13.03.2013 - v1.4.1 =
...
= 01.03.2013 - v1.2.11 =
-- Interne Korrekturen (Zeilenenden)
-- Anzeigefehler Breadcrumbs korrigiert
= 01.03.2013 - v1.2.10 =
-- Update auf Version 2.15.4 von xwolf
= 28.02.2013 - v1.2.9 =
-- Anzeigefehler behoben
= 28.02.2013 - v1.2.8 =
-- Anzeigefehler in Chrome behoben
= 27.02.2013 - v1.2.7 =
-- Style der "Weiterlese"-Links angepasst
...
-- Footer-Widgets werden bei kleinen Displays untereinander angezeigt
= 25.01.2013 - v1.2.4 =
-- fix sync problems
...
= 24.01.2013 - v1.2.1 =
-- Neue Optionen für DSE und Impressum (Hoster und Freitext)
= 24.01.2013 - v1.2.0 =
-- Neue Optionen für DSE und Impressum
= 23.01.2013 - v1.1.4 =
-- Änderungen vom Original-Projekt übernommen
-- Link zu "Allen Artikeln" unter den älteren Artikeln aktiverbar
= 22.01.2013 - v1.1.3 =
-- Bugfix: Probleme mit der Menü-Anzeige.
-- Bugfix: Optionen im Menü deutlicher formuliert.
= 21.01.2013 - v1.1.2 =
-- Bugfix: Anpassungen im Stylesheet
= 20.01.2013 - v1.1.1 =
-- Bugfix: Commentbubble wurde noch auf der Startseite angezeigt.
= 20.01.2013 - v1.1.0 =
-- Unterstützung für Plugin "Announcer" hinzugefügt.
